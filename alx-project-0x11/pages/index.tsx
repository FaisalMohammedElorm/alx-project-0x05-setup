    ...
    <div className="flex flex-col items-center min-h-screen bg-gray-100 p-4">
      ...
      {generatedImages.length ? (
        <div className="mt-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 border max-w-full md:max-w-[1100px] p-2 overflow-y-scroll h-96 rounded-lg bg-white shadow-sm">
